 ...
 */
public class L01C05S03M01 implements Watcher {

    private final static Logger log = LoggerFactory.getLogger(L01C05S03M01.class);

    private static CountDownLatch connectedSemaphore = new CountDownLatch(1);

    public static void main(String[] args) throws Exception {
        ZooKeeper zk = new ZooKeeper(Constants.ZK_HOSTS, Constants.SESSION_TIMEOUT, new L01C05S03M01());

 ...
 */
public class B01C05S03M05 implements Watcher {

    private final static Logger log = LoggerFactory.getLogger(B01C05S03M05.class);

    private static CountDownLatch connectedSemaphore = new CountDownLatch(1);
    private static ZooKeeper zk = null;

    public static void main(String[] args) throws Exception {
        String path = "/B01C05S03M05";
        zk = new ZooKeeper(Constants.ZK_HOSTS, Constants.SESSION_TIMEOUT, new B01C05S03M05());

 ...
 */
public class B01C05S03M07 implements Watcher {

    private final static Logger log = LoggerFactory.getLogger(B01C05S03M07.class);
    ...
    public static void main(String[] args) throws Exception {
        String path = "/B01C05S03M07";
        zk = new ZooKeeper(Constants.ZK_HOSTS, Constants.SESSION_TIMEOUT, new B01C05S03M07());

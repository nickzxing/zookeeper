 ...
 */
public class B01C05S03M09 implements Watcher {

    private final static Logger log = LoggerFactory.getLogger(B01C05S03M09.class);

    private static CountDownLatch connectedSemaphore = new CountDownLatch(1);

    public static void main(String[] args) throws Exception {
        String path = "/B01C05S03M09";
        ZooKeeper zk1 = new ZooKeeper(Constants.ZK_HOSTS, Constants.SESSION_TIMEOUT, new B01C05S03M09());
        ...
        ZooKeeper zk2 = new ZooKeeper(Constants.ZK_HOSTS, Constants.SESSION_TIMEOUT, new B01C05S03M09());
